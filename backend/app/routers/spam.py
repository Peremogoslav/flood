...
@router.post("/start")
async def start_spam(payload: SpamStartIn, db: Session = Depends(get_db)):
        ...
        try:
            ...
            for peer in peers:
                ...
                try:
                    ...
                    pass
                await asyncio.sleep(random.randint(payload.min_delay, payload.max_delay))
        finally:
